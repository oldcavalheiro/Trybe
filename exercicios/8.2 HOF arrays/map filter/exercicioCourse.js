...
// 1. crie uma string com nome genero e autor do livro
let expectedResult = [
...
// 2. nome do autor e idade qnd lançou o livro
expectedResult = [
  {
    age: 31,
    author: 'Isaac Asimov',
...
// 3. array com todos os objetos que possuem gênero ficção científica ou fantasia
expectedResult = [
  {
    id: 1,
    name: 'As Crônicas de Gelo e Fogo',
...
// 7. livro escrito pela pessoa cujo nome registrado começa com três iniciais (terminam com um ponto).
